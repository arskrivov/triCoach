...
/**
 * Login screen — email/password inputs, "Sign in" button,
 * link to register, and inline error display.
 *
 * On successful sign-in the auth state change in the root layout
 * handles navigation to the dashboard.
 *
 * @see Requirements 2.4, 2.5, 2.6, 2.10
 */

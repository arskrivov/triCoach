/**
 * TypeScript type definitions for TriCoach mobile app.
 * These types mirror the backend API response schemas.
 *
 * Ported from frontend/lib/types.ts with mobile-specific additions.
 */

// ============================================================================
// Core Types (ported from web frontend)
// ============================================================================
...
/**
 * Full activity detail returned by `GET /activities/{id}`.
 * Extends ActivitySummary with route, lap, HR zone, exercise, and analysis data.
 */
